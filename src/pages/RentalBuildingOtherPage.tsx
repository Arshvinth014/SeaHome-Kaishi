...
import { RentalBuildingOtherDiscovery } from '../components/seahome/RentalBuildingOther/RentalBuildingOtherDiscovery';
...
const RentalBuildingOtherPage: React.FC = () => {
  ...
  return (
    <div className="bg-gray-50/40 min-h-screen py-6">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        {/* Office Rentals PageHeader styled for Rental Building / Other */}
        <PageHeader
          totalListings="1,557"
          titlePrefix="Search for"
          titleHighlight="office buildings and other property listings."
          breadcrumbCurrent="Buildings & Other for Rent"
        />

        {/* Interactive Map search panel with Blue Theme */}
        <div className="mt-5 rounded-lg border-2 border-sky-200/80 bg-sky-50/40 p-3 sm:p-4 shadow-xs">
          ...
          {/* In-panel quick filters for mobile */}
          ...
          <div className="mt-4 border-t border-sky-200/60 pt-3 text-xs sm:text-sm font-medium leading-relaxed text-sky-950">
            Looking for office buildings or other commercial rental properties? Look no further than Sea Home! We offer a wide selection of office buildings and other commercial rental properties nationwide, with various search options including by region and train line. Sea Home fully supports your search for office buildings and other commercial rental properties.
          </div>
        </div>

        {/* Building Discovery & Listings Component */}
        <RentalBuildingOtherDiscovery onNavigate={openListings} />
...
export default RentalBuildingOtherPage;
