...
import { RentalLandDiscovery } from '../components/seahome/LandRentals/RentalLandDiscovery';
    ...
    return (
        <div className="bg-gray-50/40 min-h-screen py-6">
            ...
            <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                ...
                {/* Office Rentals PageHeader component styled for Land for Rent */}
                <PageHeader 
                    totalListings="6,616" 
                    titlePrefix="Search for"
                    titleHighlight="land for rent property listings"
                    breadcrumbCurrent="Land for Rent"
                />

                {/* Interactive Map search panel */}
                <div className="mt-5 rounded-lg border-2 border-sky-200/80 bg-sky-50/40 p-3 sm:p-4 shadow-xs">
                    ...
                    {/* Ending Description Sentence */}
                    <div className="mt-4 border-t border-sky-200/60 pt-3 text-xs sm:text-sm font-medium leading-relaxed text-sky-950">
                        Looking for land to rent? Look no further than SeaHome! We offer a wide selection of land properties nationwide, with various search options including region and train line. SeaHome fully supports your land rental search.
                    </div>
                </div>

                {/* Rental Land Discovery & Listings Component */}
                <RentalLandDiscovery onNavigate={openListings} />
