...
import { WarehouseDiscovery } from '../components/seahome/WarehouseRentals/WarehouseDiscovery';
  ...
  return (
    <div className="bg-gray-50/40 min-h-screen py-6">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        {/* Office Rentals PageHeader styled for Rental Warehouse */}
        <PageHeader
          totalListings="7,661"
          titlePrefix="Search for"
          titleHighlight="rental warehouse property listings"
          breadcrumbCurrent="Warehouse for Rent"
        />
        ...
        <div className="mt-5 rounded-lg border-2 border-sky-200/80 bg-sky-50/40 p-3 sm:p-4 shadow-xs">
          ...
          <div className="mt-4 border-t border-sky-200/60 pt-3 text-xs sm:text-sm font-medium leading-relaxed text-sky-950">
            Looking for a warehouse or storage unit for rent? Look no further than Sea Home! We offer a wide selection of warehouses and storage units nationwide, with various search options including location and train line. Sea Home is here to fully support your warehouse or storage unit search.
          </div>
        </div>

        {/* Warehouse Discovery & Listings Component */}
        <WarehouseDiscovery onNavigate={openListings} />
